...
if __name__ == "__main__":
    ...
    serve_on_subtensor(args.host_address, args.port, netuid, max_retries=5, wait_for_inclusion=True, wait_for_finalization=True) #FIXME hardcoded to localhost
    
    main(config.orchestrator_url, config.miner_script, config.batch_size, config.epochs, config.validator_urls)