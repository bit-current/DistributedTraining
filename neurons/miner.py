...
strategy = HivemindStrategy(
    ...
    host_maddrs=[f"/ip4/{args.dht_host_address}/tcp/{args.dht_tcp_port}", f"/ip4/{args.dht_host_address}/udp/{args.dht_udp_port}"],
    announce_maddrs=[f"/ip4/{args.dht_external_address}/tcp/{args.dht_tcp_port}", f"/ip4/{args.dht_external_address}/udp/{args.dht_udp_port}"],
    use_ipfs=False,
